...
int main(int argc, char* argv[])
{
    ...
    //
    lpt::stack::extended_symbol_info ei1(reinterpret_cast<const lpt::stack::address_type>(0x1111));
    lpt::stack::extended_symbol_info ei2(reinterpret_cast<lpt::stack::address_type>(0x2222));
    std::swap(ei1, ei2);
    assert( s1.depth() == 0 && s2.depth() > 0 );

    lpt::stack::call_frame f1(reinterpret_cast<lpt::stack::address_type>(0x1111)), f2;
